#region usingsusing System;using System.Collections.Generic;using System.Linq;using System.Text;using Microsoft.Xna.Framework.Graphics;using Microsoft.Xna.Framework;using Microsoft.Xna.Framework.Input;using System.Drawing;using Color = Microsoft.Xna.Framework.Color;#endregionnamespace ScratchyXna{    public class PlayScreen : Scene    {        public enum PlayScreenModes
        ...
        /// <summary>
        /// The PlayScreen for the OTHER player
        /// </summary>
        public PlayScreen OtherPlayerScreen
        {
            get
            {
                if (ActivePlayer == 1)
                {
                    return ((SpaceInvaders)Game).Scenes["player2"] as PlayScreen;
                }
                else
                {
                    return ((SpaceInvaders)Game).Scenes["player1"] as PlayScreen;
                }
            }
        }

        /// <summary>
        /// Make the other play screen visible
        /// </summary>
        public void ShowOtherPlayerScreen()
        {
            //OtherPlayerScreen.ShowPlayerNumber();
            ShowScene(OtherPlayerScreen);
        }        /// <summary>
        /// Bring up one of the spare lives to be the active player
        /// </summary>        public void RaiseShip()
        {
            ship.Hide();
            ship.X = 0;
            Wait(0.4, () =>
